    ...
    datasets: [
      {
        ...
        backgroundColor:theme.palette?.systemColor1?.main ||'#'+(Math.random() * 0xfffff * 1000000).toString(16).slice(0,6),
        pointRadius: 2,
        pointStyle: 'circle',
        borderWidth: 1,
      },
    ...
    datasets: [
      {
        ...
        // backgroundColor:'#'+(Math.random() * 0xfffff * 1000000).toString(16).slice(0,6),
        backgroundColor:theme.palette?.systemColor1?.main ||'#'+(Math.random() * 0xfffff * 1000000).toString(16).slice(0,6),
        borderColor: theme.palette.systemColor1.main,
        pointRadius: 2,
        pointStyle: 'rect',
        borderWidth: 1,
      },
    ...
    datasets: [
      {
        ...
        fill:true,
        backgroundColor: themes.default?.palette?.systemColor4?.main,
        borderColor: themes.default?.palette?.systemColor4?.light,
        borderWidth: 1,
      },
      // {
      //   label: '2nd Dataset',
